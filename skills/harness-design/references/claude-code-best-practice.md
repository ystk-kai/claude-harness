...
distilled_commit: b0e01c1d91ec3a31a6de7f86809a4c99c32f7fd3
...
13. **frontmatter の正確なリファレンスは best-practice/ にある**。skills・commands・subagents 各 16
    ...
    (bundled skills 13、slash commands 86、agent types 5) も同ファイル群にある。
...
| command frontmatter + 公式コマンド | `best-practice/claude-commands.md` | command の 16 フィールドと built-in slash command 86 個 |
...
- **公式 slash command 86 個・CLI フラグ・env vars の全リスト** — `best-practice/claude-commands.md` と
