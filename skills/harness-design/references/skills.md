...
distilled_commit: 9d2f1ae187231d8199c64b5b762e1bdf2244733d
...
| Office 生成 skill | `skills/{docx,pptx,xlsx}/` | scripts/office (+ docx は scripts/templates)、pptx は editing.md / pptxgenjs.md を分離 |
